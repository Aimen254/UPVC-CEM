                ...
                <ul class="dash-navbar">
                    ...
                    @if( Gate::check('show hrm dashboard') || Gate::check('show project dashboard') || Gate::check('show account dashboard'))
                        <li class="dash-item dash-hasmenu
                            ...
                            <a href="{{ url('/') }}" class="dash-link "><span class="dash-micon"><i class="ti ti-home"></i></span><span class="dash-mtext">{{__('Dashboard')}}</span>
                                        ...
                                        <li class="dash-item dash-hasmenu {{(Request::segment(1) == 'chart-of-account' || Request::segment(1) == 'journal-entry' || Request::segment(2) == 'ledger' ||  Request::segment(2) == 'balance-sheet' ||  Request::segment(2) == 'trial-balance')? 'active dash-trigger' :''}}">
                                            ...
                                            <ul class="dash-submenu">
                                                ...
                                                <li class="dash-item {{ (Request::route()->getName() == 'report.ledger' ) ? ' active' : '' }}">
                                                 ...
                                                 <li class="dash-item {{ (Request::route()->getName() == 'balance-entry.edit' || Request::route()->getName() == 'balance.entry.create' || Request::route()->getName() == 'balance-entry.index' || Request::route()->getName() == 'balance-entry.show') ? ' active' : '' }}">
                                                    <a class="dash-link" href="{{ route('balance-entry.index') }}">{{__('Balance Account')}}</a>
                                                </li>
                                                 <li class="dash-item {{ (Request::route()->getName() == 'balnce.ledger' ) ? ' active' : '' }}">
                                                    <a class="dash-link" href="{{route('balnce.ledger')}}">{{__('Balance Ledger Summary')}}</a>
                                                </li>
                        ...
                        <li class="dash-item dash-hasmenu">
                            ...
                            <ul class="dash-submenu">
                                @if(Gate::check('manage product & service'))
                                  <li class="dash-item dash-hasmenu  {{ (Request::segment(1) == 'productservice' || Request::segment(1) == 'windows') ? 'active dash-trigger' : ''}}">
                                            <a class="dash-link" href="#">{{__('Product & Services')}}<span class="dash-arrow"><i data-feather="chevron-right"></i></span></a>
                                        <ul class="dash-submenu">
                                            
                                            <li class="dash-item {{ (request()->is('productservice*') ? 'active' : '')}}">
                                                <a class="dash-link" href="{{ route('productservice.index') }}">{{__('Product & Services')}}</a>
                                            </li>
                                            
                                        <li class="dash-item dash-hasmenu {{ (Request::segment(1) == 'assignformulas' || Request::segment(1) == 'addvalues' || Request::segment(1) == 'images' || Request::segment(1) == 'formulas') ? 'active dash-trigger' : ''}}">
                                                    <a class="dash-link" href="#">{{__('Windows')}}<span class="dash-arrow"><i data-feather="chevron-right"></i></span></a>
                                                <ul class="dash-submenu">
                                                      <li class="dash-item {{ (request()->is('formulas*') ? 'active' : '')}}">
                                                        <a class="dash-link" href="{{route('formulas')}}">{{__('Add Formula')}}</a>
                                                    </li>
                                                    <li class="dash-item {{ (request()->is('images*') ? 'active' : '')}}">
                                                        <a class="dash-link" href="{{route('images')}}">{{__('Add Images')}}</a>
                                                    </li>
                                                    <li class="dash-item {{ (request()->is('assignformulas*') ? 'active' : '')}}">
                                                        <a class="dash-link" href="{{route('formasign.index')}}">{{__('Assign Formulas')}}</a>
                                                    </li>
                                                    
                                                    <li class="dash-item {{ (request()->is('addvalues*') ? 'active' : '')}}">
                                                        <a class="dash-link" href="{{ route('usrimg') }}">{{__('Add Values')}}</a>
                                                    </li>
