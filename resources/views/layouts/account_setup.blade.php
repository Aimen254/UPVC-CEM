<div class="card sticky-top" style="top:30px">
    <div class="list-group list-group-flush" id="useradd-sidenav">
        ...
        <a href="{{ route('access-type.index') }}" class="list-group-item list-group-item-action border-0 {{ (Request::route()->getName() == 'access-type.index' ) ? 'active' : '' }}   ">{{__('Access Type')}}<div class="float-end"><i class="ti ti-chevron-right"></i></div></a>
                <a href="{{ route('frames.index') }}" class="list-group-item list-group-item-action border-0 {{ (Request::route()->getName() == 'frames.index' ) ? 'active' : '' }}   ">{{__('Frame')}}<div class="float-end"><i class="ti ti-chevron-right"></i></div></a>
