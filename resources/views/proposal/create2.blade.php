                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group" id="customer-box">
                                ...
                                <input class="form-control" type="hidden" name="customer_id" value="{{$customers->id}}">
                                <input class="form-control" type="hidden" name="lead_id" value="{{$customers->lead_id}}">
                            </div>
                            @if(!empty($customers))
                                <div class="row">
                                    <div class="col-md-5">
                                        ...
                                        <div class="bill-to">
                                            <small>
                                                <span>{{$customers->billing_name}}</span><br>
                                                <span>{{$customers->billing_phone}}</span><br>
                                                <span>{{$customers->billing_address}}</span><br>
                                                
                                                <span>{{$customers->billing_country}} ,   {{$customers->billing_city}}   , {{$customers->billing_state}}</span>
                                            </small>
                                        </div>
                                    </div>
                                </div>
