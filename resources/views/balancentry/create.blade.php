...
@section('content')
    ...
    {{ Form::open(array('route' => ['balance.entry.store'],'class'=>'w-100')) }}
                    ...
                    <div class="table-responsive">
                        <table class="table mb-0" data-repeater-list="accounts" id="sortable-table">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="form-group price-input">
                                        {{ Form::text('debit','', array('class' => 'form-control debit','required'=>'required','placeholder'=>__('Revenue'),'required'=>'required')) }}
                                    </div>
                                </td>
                                <td>
                                    <div class="form-group price-input">
                                        {{ Form::text('credit','', array('class' => 'form-control credit','required'=>'required','placeholder'=>__('Expense'),'required'=>'required')) }}
                                    </div>
                                </td>
                                <td>
                                    <div class="form-group">
                                        {{ Form::text('discription','', array('class' => 'form-control','placeholder'=>__('Description'),'value' => '')) }}
                                    </div>
                                </td>
                                ...
                                <td>
                            <td>{{ Form::text('amount','', array('class' => 'form-control amt', 'id'  => 'am',) ) }}</td>
                                </td>
                            </tr>
                            </tbody>
                            <tfoot>
                            <tr>
                                ...
                                <td>&nbsp;</td>
                                <td></td>
                                <td class="text-end"><strong>{{__('Total Expense')}} ({{\Auth::user()->currencySymbol()}})</strong></td>
                            ...
                            <tr>
                                ...
                                <td>&nbsp;</td>
                                <td>&nbsp;</td>
                                <td class="text-end"><strong>{{__('Total Revenue')}} ({{\Auth::user()->currencySymbol()}})</strong></td>
                            ...
                            <tr>
                                ...
                                <td>&nbsp;</td>
                                <td>&nbsp;</td>
                                <td class="text-end"><strong>{{__('Total Balance')}} ({{\Auth::user()->currencySymbol()}})</strong></td>
    ...
    <div class="modal-footer">
        <input type="button" value="{{__('Cancel')}}" onclick="location.href = '{{route("balance-entry.index")}}';" class="btn btn-light">
