                ...
                <div class="card-body">
                    <div class="invoice">
                        <div class="invoice-print">
                            ...
                            <div class="row mt-4">
                                <div class="col-md-12">
                                    <div class="font-weight-bold">{{__('Balance Account Summary')}}</div>
                                    <div class="table-responsive mt-2">
                                        <table class="table mb-0 ">
                                            <tr>
                                                ...
                                                <th class="text-dark">{{__('Revenue')}}</th>
                                            ...
                                            @foreach($accounts as $key =>$account)
                                                ...
                                                <tr>
                                                    ...
                                                    <td>{{!empty($account->discription)?$account->discription:'-'}}</td>
                                                    <td>{{\Auth::user()->priceFormat($account->revenue)}}</td>
                                                    <td>{{\Auth::user()->priceFormat($account->expense)}}</td>
                                                    <td class="text-end">
                                                        @if($account->revenue!=0)
                                                            {{\Auth::user()->priceFormat($account->revenue)}}
                                                        @else
                                                            {{\Auth::user()->priceFormat($account->expense)}}
                                                        @endif
                                                    </td>
                                                </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-end">{{\Auth::user()->priceFormat($journalEntry->totalExpense())}}</td>
                                            </tr>
                                            <tr>
                                                <td colspan="4"></td>
                                                <td class="text-end"><b>{{__('Total Debit')}}</b></td>
                                                <td class="text-end">{{\Auth::user()->priceFormat($journalEntry->totalRevenue())}}</td>
                                            </tr>
                                            </tfoot>
                                        </table>
                                    </div>
