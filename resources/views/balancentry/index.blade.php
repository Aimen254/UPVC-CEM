...
@section('action-btn')
    <div class="float-end">
        @can('create journal entry')
            <a href="{{ route('balance.entry.create') }}" data-title="{{__('Create New Balance')}}" data-bs-toggle="tooltip"  title="{{__('Create')}}" class="btn btn-sm btn-primary">
                        ...
                        <table class="table datatable">
                            ...
                            @foreach ($journalEntries as $journalEntry)
                                <tr>
                                    ...
                                    <td>
                                        {{ \Auth::user()->priceFormat($journalEntry->totalRevenue())}}
                                    </td>
                                    <td>{{!empty($journalEntry->discription)?$journalEntry->discription:'-'}}</td>
                                    <td>
