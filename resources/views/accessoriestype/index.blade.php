...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item">{{__('Accessories Type')}}</li>
@endsection

@section('action-btn')
    <div class="float-end">
        @can('create constant custom field')
            <a href="#" data-url="{{ route('access-type.create') }}" data-bs-toggle="tooltip" title="{{__('Create')}}" data-ajax-popup="true" data-title="{{__('Create New Access Type')}}" class="btn btn-sm btn-primary">
                                        ...
                                        <td class="Action">
                                            ...
                                            @can('edit constant custom field')
                                                    <div class="action-btn bg-primary ms-2">
                                                        <a href="#" class="mx-3 btn btn-sm align-items-center" data-url="{{ route('access-type.edit',$field->id) }}" data-ajax-popup="true" data-title="{{__('Edit Access Type')}}" data-bs-toggle="tooltip" title="{{__('Edit')}}" data-original-title="{{__('Edit')}}">
