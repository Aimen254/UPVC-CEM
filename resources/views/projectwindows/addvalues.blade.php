{{ Form::model($milestone, array('route' => array('project.window.update', $milestone->id),'enctype' => 'multipart/form-data', 'method' => 'POST')) }}
...
<div class="row">
        ...
        <div class="col-md-6">
            <div class="form-check form-check-inline">
                ...
                <label class="custom-control-label form-label" for="customRadio6">{{__('Latchlock')}}</label>
            </div>
        </div>
          <div class="col-12 form-group">
