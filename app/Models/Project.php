...
class Project extends Model
{
    ...
    public static $fixtype = [
        '70MM' => '70MM',
        '60MM' => '60MM'
    ];
    public static $doorlock = [
        'Tlock' => 'Tlock'
    ];
    public static $slidelock = [
        'gear_handles' => 'Gear Handles',
        'latchlock' => 'LatchLock'
    ];
    public static $openlock = [
        'gear_handles' => 'Gear Handles',
        'cockspurhandle' => 'Cockspur Handel'
    ];
    public static $opendir = [
        'outwardsingle' => 'Outward Single Opener',
        'inwardsingle' => 'Inward Single Opener',
        'outwardouble' => 'Outward Double Opener',
        'inwardouble' => 'Inward Double Opener',
    ];
    public static $hing = [
        'twohing' => '2D Hindge',
        'thhing' => '3D Hindge'
    ...
    {
        return $this->hasMany('App\Models\ProjectWindow', 'project', 'id')->where('designtype','!=','door')->where('jobcost', '=', Null);
    }

    public function doors()
    {
        return $this->hasMany('App\Models\ProjectWindow', 'project', 'id')->where('designtype','door');
    }
      public function buraq()
    {
        return $this->hasMany('App\Models\ProjectWindow', 'project', 'id')->where('company','Buraq');
    }
     
    
       public function asapen()
    {
        return $this->hasMany('App\Models\ProjectWindow', 'project', 'id')->where('company','Asaspen');
    }
        public function winplast()
    {
        return $this->hasMany('App\Models\ProjectWindow', 'project', 'id')->where('company','Winplast');
    }
       public function sliding()
    {
        return $this->hasMany('App\Models\ProjectWindow', 'project', 'id')->where('designtype','sliding');
    }
      public function jobcosts()
    {
        return $this->hasMany('App\Models\ProjectWindow', 'project', 'id')->where('jobcost','jobcost');
    }
        public function buraqentry()
    {
        return $this->hasMany('App\Models\ProjWinEntry', 'project_id', 'id')->where('company','Buraq')->where('final', 1);
    }
   public function asapenentry()
    {
        return $this->hasMany('App\Models\ProjWinEntry', 'project_id', 'id')->where('company','Asaspen')->where('final', 1);
    }
      public function winplastentry()
    {
        return $this->hasMany('App\Models\ProjWinEntry', 'project_id', 'id')->where('company','Winplast')->where('final', 1);
    }
