...
//                {
                    ...
                    $data['leads']  = Lead::where('created_by' , \Auth::user()->id)->count();
                    $data['owner']  = Lead::where('created_by' , \Auth::user()->id)->where('whoishe', 'Owner')->count();
                                       $lead_id       = Lead::where('created_by' , \Auth::user()->id)->get();
                                        $id = Lead::where('created_by' , \Auth::user()->id)->pluck('id');
                                
                                // $prop = Proposal::where('lead_id', '=', $id)->get();
                                 $data['quotes']  = Proposal::where('created_by' , \Auth::user()->id)->count();
   
              
                
//  $data['quotes']  = Lead::where('created_by' , \Auth::user()->id)->where('quote' , '1')->count();
