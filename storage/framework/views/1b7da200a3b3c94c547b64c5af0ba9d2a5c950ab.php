                                                    ...
                                                    <tr>
                                                        <td align="left" style="font-size:0px;padding:0px 25px 0px 25px;padding-top:0px;padding-right:50px;padding-bottom:0px;padding-left:50px;word-break:break-word;">
                                                            <div style="font-family:Open Sans, Helvetica, Arial, sans-serif;font-size:13px;line-height:22px;text-align:left;color:#797e82;">
                                                                <p style=" line-height:32px"><b style="font-weight:700"><?php echo e(__('Subject : ').'We are writing to inform you that we have received your '.$payment->invoice.' payment.'); ?></b></p>
                                                                <p style="line-height:32px"><b style="font-weight:700"><?php echo e(__('Dear ').$payment->name.','); ?></b></p>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td align="left" style="font-size:0px;padding:0px 25px 0px 25px;padding-top:0px;padding-right:50px;padding-bottom:0px;padding-left:50px;word-break:break-word;">
                                                            <div style="font-family:Open Sans, Helvetica, Arial, sans-serif;font-size:13px;line-height:22px;text-align:left;color:#797e82;">
                                                                <p style="margin: 10px 0;"><?php echo e(__('We have recieved your amount '.$payment->amount.' payment for '.$payment->invoice. ' submited on date '.$payment->date.'.')); ?></p>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td align="left" style="font-size:0px;padding:0px 25px 0px 25px;padding-top:0px;padding-right:50px;padding-bottom:0px;padding-left:50px;word-break:break-word;">
                                                            <div style="font-family:Open Sans, Helvetica, Arial, sans-serif;font-size:13px;line-height:22px;text-align:left;color:#797e82;">
                                                                <p style="margin: 10px 0;"><?php echo e(__('Your '.$payment->invoice.' Due amount is '.$payment->dueAmount)); ?></p>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td align="left" style="font-size:0px;padding:0px 25px 0px 25px;padding-top:0px;padding-right:50px;padding-bottom:0px;padding-left:50px;word-break:break-word;">
                                                            <div style="font-family:Open Sans, Helvetica, Arial, sans-serif;font-size:13px;line-height:22px;text-align:left;color:#797e82;">
                                                                ...
                                                                <p style="margin: 10px 0;"><i style="font-style:normal"><?php echo e(__('We appreciate your prompt payment and look forward to continued business with you in the future.')); ?></i></p>
                                                                <p style="margin: 10px 0;"><i style="font-style:normal"><?php echo e(__('Thank you very much and have a good day.')); ?></i></p>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                    <tr>
...
<?php /**PATH /home2/babarras/public_html/resources/views/email/invoice_payment_create.blade.php ENDPATH**/ ?>