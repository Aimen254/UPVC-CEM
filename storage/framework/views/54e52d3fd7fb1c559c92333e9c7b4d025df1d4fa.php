...
<?php $__env->startSection('page-title'); ?>
    <?php echo e(__('Balance Journal Entry')); ?>
...
<?php $__env->startSection('action-btn'); ?>
    <div class="float-end">
        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('create journal entry')): ?>
            <a href="<?php echo e(route('balance.entry.create')); ?>" data-title="<?php echo e(__('Create New Balance')); ?>" data-bs-toggle="tooltip"  title="<?php echo e(__('Create')); ?>" class="btn btn-sm btn-primary">
                ...
                <div class="card-body table-border-style">
                    <div class="table-responsive">
                        <table class="table datatable">
                            <thead>
                            <tr>
                                <th> <?php echo e(__('Balance ID')); ?></th>
                            ...
                            <?php $__currentLoopData = $journalEntries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $journalEntry): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td>
                                        <?php echo e(\Auth::user()->priceFormat($journalEntry->totalRevenue())); ?>

                                    </td>
                                    <td><?php echo e(!empty($journalEntry->discription)?$journalEntry->discription:'-'); ?></td>
                                    <td>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/babarras/public_html/resources/views/balancentry/index.blade.php ENDPATH**/ ?>