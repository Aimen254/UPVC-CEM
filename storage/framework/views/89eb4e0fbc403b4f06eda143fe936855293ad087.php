...
<?php $__env->startSection('content'); ?>
                        ...
                        <table class="table mb-0" data-repeater-list="accounts" id="sortable-table">
                            ...
                            <tr>
                                ...
                                <td width="20%" class="form-group pt-0">
                                    <?php echo e(Form::select('type', $accounts,'', array('class' => 'form-control type select', 'id' => 'type' ,'required'=>'required'))); ?>
                                ...
                                <?php echo e(Form::select('profile', $slide,'', array('class' => 'form-control profile select', 'id' => 'slide' ,'required'=>'required'))); ?>

                                </div>
                                <div style="display: none;" id="fixselect">
                                <?php echo e(Form::select('profile', $fix,'', array('class' => 'form-control profile select', 'id' => 'fix' ,'required'=>'required'))); ?>


                                </div>
                                <div style="display: none;" id="openselect">
                                <?php echo e(Form::select('profile', $open,'', array('class' => 'form-control profile select', 'id' => 'open' ,'required'=>'required'))); ?>


                                </div>
                                   <div style="display: none;" id="doorselect">
                                <?php echo e(Form::select('profile', $door,'', array('class' => 'form-control profile select', 'id' => 'door' ,'required'=>'required'))); ?>
                                ...
                                <td >
                                    <div style="display: block;" id="slidetypee">
                                       <?php echo e(Form::select('designtyperatio', $slidetype,'', array('class' => 'form-control designtyperatio select', 'id' => 'slidetype' ,'required'=>'required'))); ?>

                                    </div>
                                    <div style="display: none;" id="fixtypee">
                                       <?php echo e(Form::select('designtyperatio', $fixtype,'', array('class' => 'form-control designtyperatio  select', 'id' => 'fixtype' ,'required'=>'required'))); ?>

                                    </div>
                                    <div style="display: none;" id="opentypee">
                                       <?php echo e(Form::select('designtyperatio', $opentype,'', array('class' => 'form-control designtyperatio select', 'id' => 'opentype' ,'required'=>'required'))); ?>

                                    </div>
                                     <div style="display: none;" id="doortypee">
                                       <?php echo e(Form::select('designtyperatio', $doortype,'', array('class' => 'form-control designtyperatio select', 'id' => 'doortype' ,'required'=>'required'))); ?>

                                    </div>
                                </td>
                                <td>
                                     <div style="display: block;" id="slidelockk">
                                       <?php echo e(Form::select('lock', $slidelock,'', array('class' => 'form-control lock select', 'id' => 'slidelock' ,'required'=>'required'))); ?>

                                    </div> 
                                    <div style="display: none;" id="openlockk">
                                       <?php echo e(Form::select('lock', $openlock,'', array('class' => 'form-control lock select', 'id' => 'openlock' ,'required'=>'required'))); ?>

                                    </div> 
                                     <div style="display: none;" id="doorlockk">
                                       <?php echo e(Form::select('lock', $doorlock,'', array('class' => 'form-control lock select', 'id' => 'doorlock'))); ?>

                                    </div>
                                </td>
                                <td style="display: none;" id="opendirr">
                                <?php echo e(Form::select('opendir', $opendir,'', array('class' => 'form-control opendir select', 'id' => 'opendir' ,'required'=>'required'))); ?>

                                </td>
                                <td style="display: none;" id="hingg">
                                <?php echo e(Form::select('hing', $hing,'', array('class' => 'form-control hing select', 'id' => 'hing' ,'required'=>'required'))); ?>

                                </td>
                              
                                  <td style="display: none;" id="handlee">
                                <?php echo e(Form::select('handle', $doorhandle,'', array('class' => 'form-control handle select', 'id' => 'handle' ,'required'=>'required'))); ?>
    ...
    <input type="button" value="<?php echo e(__('Cancel')); ?>" onclick="location.href = '<?php echo e(route('project.quote.index',$project_id)); ?>';" class="btn btn-light">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/babarras/public_html/resources/views/projectwindows/quote.blade.php ENDPATH**/ ?>