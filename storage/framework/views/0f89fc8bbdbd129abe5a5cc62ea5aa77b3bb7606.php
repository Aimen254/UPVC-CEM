                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group" id="customer-box">
                                ...
                                <input class="form-control" type="hidden" name="customer_id" value="<?php echo e($customers->id); ?>">
                                <input class="form-control" type="hidden" name="lead_id" value="<?php echo e($customers->lead_id); ?>">
                            </div>
                            <?php if(!empty($customers)): ?>
                                <div class="row">
                                    <div class="col-md-5">
                                        ...
                                        <div class="bill-to">
                                            <small>
                                                <span><?php echo e($customers->billing_name); ?></span><br>
                                                <span><?php echo e($customers->billing_phone); ?></span><br>
                                                <span><?php echo e($customers->billing_address); ?></span><br>
                                                
                                                <span><?php echo e($customers->billing_country); ?> ,   <?php echo e($customers->billing_city); ?>   , <?php echo e($customers->billing_state); ?></span>
                                            </small>
                                        </div>
                                    </div>
                                </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/babarras/public_html/resources/views/proposal/create2.blade.php ENDPATH**/ ?>