        ...
        <div class="row align-items-center justify-content-between">
            ...
            <div class="col-sm-auto text-sm-end d-flex align-items-center">
                ...
                <div class="action-btn bg-success ms-2">
                   <a href="<?php echo e(route('project.increment', [$project->id,$user->id])); ?>" class="mx-4 btn btn-sm  align-items-center btn" title="<?php echo e(__('Increment')); ?>">
...
<?php /**PATH /home2/babarras/public_html/resources/views/projects/users.blade.php ENDPATH**/ ?>