    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="mt-2 " id="multiCollapseExample1">
                <div class="card">
                    <div class="card-body">
                        <?php echo e(Form::open(array('route' => array('balnce.ledger'),'method' => 'GET','id'=>'report_ledger'))); ?>
    ...
    <div id="printableArea">
        <div class="row mt-2">
            <div class="col">
                ...
                <div class="card p-4 mb-4">
                    ...
                    <h7 class="text-sm mb-0"><?php echo e(__('Balance Summary')); ?></h7>
                </div>
            </div>
        ...
        <?php if(!empty($account)): ?>
            <div class="row mt-2">
                ...
                <div class="col">
                    <div class="card p-4 mb-4">
                        <h6 class="mb-0"><?php echo e(__('Total Revenue')); ?> :</h6>
                        <h7 class="text-sm mb-0"><?php echo e(\Auth::user()->priceFormat($filter['revenue'])); ?></h7>
                    </div>
                </div>
                <div class="col">
                    <div class="card p-4 mb-4">
                        <h6 class="mb-0"><?php echo e(__('Total Expense')); ?> :</h6>
                        <h7 class="text-sm mb-0"><?php echo e(\Auth::user()->priceFormat($filter['expense'])); ?></h7>
                    </div>
                </div>
                        ...
                        <div class="table-responsive">
                            <table class="table">
                                ...
                                <?php $__currentLoopData = $journalItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        <td class="Id">
                                            <a href="<?php echo e(route('balance-entry.show',$item->balance)); ?>" class="btn btn-outline-primary"><?php echo e(AUth::user()->journalNumberFormat($item->journal_id)); ?></a>
                                        </td>
                                        ...
                                        <td><?php echo e(\Auth::user()->priceFormat($item->revenue)); ?></td>
                                        <td><?php echo e(\Auth::user()->priceFormat($item->expense)); ?></td>
                                        <td>
                                            <?php if($item->revenue>0): ?>
                                                <?php $debit+=$item->revenue ?>
                                            <?php else: ?>
                                                <?php $credit+=$item->expense ?>
                                            <?php endif; ?>

                                            <?php $balance= $item->totalbalance ?>
                                            <?php if($balance>0): ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/babarras/public_html/resources/views/balancentry/summary.blade.php ENDPATH**/ ?>