<?php $__env->startSection('page-title'); ?>
    <?php echo e(__('Manage Accessories')); ?>
...
<?php $__env->startSection('breadcrumb'); ?>
    ...
    <li class="breadcrumb-item"><?php echo e(__(' Accessories')); ?></li>
<?php $__env->stopSection(); ?>
<?php $__env->startSection('action-btn'); ?>
    <div class="float-end">
        ...
        <a href="#" data-size="xl" data-url="<?php echo e(route('access.create')); ?>" data-ajax-popup="true" data-bs-toggle="tooltip" title="<?php echo e(__('Create New Product')); ?>" class="btn btn-sm btn-primary">
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class=" mt-2 " id="multiCollapseExample1">
                <div class="card">
                    <div class="card-body">
                        <?php echo e(Form::open(['route' => ['access.index'], 'method' => 'GET', 'id' => 'product_service'])); ?>
                        ...
                        <div class="d-flex align-items-center justify-content-end">
                            ...
                            <div class="col-auto float-end ms-2 mt-4">
                                ...
                                <a href="<?php echo e(route('access.index')); ?>" class="btn btn-sm btn-danger" data-bs-toggle="tooltip"
                        ...
                        <table class="table datatable">
                            ...
                            <?php $__currentLoopData = $productServices; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $productService): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr class="font-style">
                                    ...
                                    <td><?php echo e(\Auth::user()->priceFormat($productService->price)); ?></td>
                                 
                                    <td><?php echo e($productService->quantity); ?></td>
                                    <td><?php echo e(!empty($productService->types())?$productService->types()->name:''); ?></td>

                                   
                                        <td class="Action">
                                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('edit product & service')): ?>
                                                <div class="action-btn bg-info ms-2">
                                                    <a href="#" class="mx-3 btn btn-sm  align-items-center" data-url="<?php echo e(route('access.edit',$productService->id)); ?>" data-ajax-popup="true"  data-size="xl" data-bs-toggle="tooltip" title="<?php echo e(__('Edit')); ?>"  data-title="<?php echo e(__('Accessories Edit')); ?>">
                                                        <i class="ti ti-pencil text-white"></i>
                                                    </a>
                                                </div>
                                            
                                                <div class="action-btn bg-danger ms-2">
                                                    <?php echo Form::open(['method' => 'DELETE', 'route' => ['access.destroy', $productService->id],'id'=>'delete-form-'.$productService->id]); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/babarras/public_html/resources/views/accessories/index.blade.php ENDPATH**/ ?>