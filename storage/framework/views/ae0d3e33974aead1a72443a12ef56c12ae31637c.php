                ...
                <ul class="dash-navbar">
                    ...
                    <?php if( Gate::check('show hrm dashboard') || Gate::check('show project dashboard') || Gate::check('show account dashboard')): ?>
                        <li class="dash-item dash-hasmenu
                            ...
                            <a href="<?php echo e(url('/')); ?>" class="dash-link "><span class="dash-micon"><i class="ti ti-home"></i></span><span class="dash-mtext"><?php echo e(__('Dashboard')); ?></span>
                                        ...
                                        <li class="dash-item dash-hasmenu <?php echo e((Request::segment(1) == 'chart-of-account' || Request::segment(1) == 'journal-entry' || Request::segment(2) == 'ledger' ||  Request::segment(2) == 'balance-sheet' ||  Request::segment(2) == 'trial-balance')? 'active dash-trigger' :''); ?>">
                                            ...
                                            <ul class="dash-submenu">
                                                ...
                                                <li class="dash-item <?php echo e((Request::route()->getName() == 'report.ledger' ) ? ' active' : ''); ?>">
                                                 ...
                                                 <li class="dash-item <?php echo e((Request::route()->getName() == 'balance-entry.edit' || Request::route()->getName() == 'balance.entry.create' || Request::route()->getName() == 'balance-entry.index' || Request::route()->getName() == 'balance-entry.show') ? ' active' : ''); ?>">
                                                    <a class="dash-link" href="<?php echo e(route('balance-entry.index')); ?>"><?php echo e(__('Balance Account')); ?></a>
                                                </li>
                                                 <li class="dash-item <?php echo e((Request::route()->getName() == 'balnce.ledger' ) ? ' active' : ''); ?>">
                                                    <a class="dash-link" href="<?php echo e(route('balnce.ledger')); ?>"><?php echo e(__('Balance Ledger Summary')); ?></a>
                                                </li>
                        ...
                        <li class="dash-item dash-hasmenu">
                            ...
                            <ul class="dash-submenu">
                                <?php if(Gate::check('manage product & service')): ?>
                                  <li class="dash-item dash-hasmenu  <?php echo e((Request::segment(1) == 'productservice' || Request::segment(1) == 'windows') ? 'active dash-trigger' : ''); ?>">
                                            <a class="dash-link" href="#"><?php echo e(__('Product & Services')); ?><span class="dash-arrow"><i data-feather="chevron-right"></i></span></a>
                                        <ul class="dash-submenu">
                                            
                                            <li class="dash-item <?php echo e((request()->is('productservice*') ? 'active' : '')); ?>">
                                                <a class="dash-link" href="<?php echo e(route('productservice.index')); ?>"><?php echo e(__('Product & Services')); ?></a>
                                            </li>
                                            
                                        <li class="dash-item dash-hasmenu <?php echo e((Request::segment(1) == 'assignformulas' || Request::segment(1) == 'addvalues' || Request::segment(1) == 'images' || Request::segment(1) == 'formulas') ? 'active dash-trigger' : ''); ?>">
                                                    <a class="dash-link" href="#"><?php echo e(__('Windows')); ?><span class="dash-arrow"><i data-feather="chevron-right"></i></span></a>
                                                <ul class="dash-submenu">
                                                      <li class="dash-item <?php echo e((request()->is('formulas*') ? 'active' : '')); ?>">
                                                        <a class="dash-link" href="<?php echo e(route('formulas')); ?>"><?php echo e(__('Add Formula')); ?></a>
                                                    </li>
                                                    <li class="dash-item <?php echo e((request()->is('images*') ? 'active' : '')); ?>">
                                                        <a class="dash-link" href="<?php echo e(route('images')); ?>"><?php echo e(__('Add Images')); ?></a>
                                                    </li>
                                                    <li class="dash-item <?php echo e((request()->is('assignformulas*') ? 'active' : '')); ?>">
                                                        <a class="dash-link" href="<?php echo e(route('formasign.index')); ?>"><?php echo e(__('Assign Formulas')); ?></a>
                                                    </li>
                                                    
                                                    <li class="dash-item <?php echo e((request()->is('addvalues*') ? 'active' : '')); ?>">
                                                        <a class="dash-link" href="<?php echo e(route('usrimg')); ?>"><?php echo e(__('Add Values')); ?></a>
                                                    </li>
...
<?php /**PATH /home2/babarras/public_html/resources/views/partials/admin/menu.blade.php ENDPATH**/ ?>