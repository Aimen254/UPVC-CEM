...
use App\Http\Controllers\ImageFormulaController;
use App\Http\Controllers\UserWindowController;
use App\Http\Controllers\AccessoriesController;
use App\Http\Controllers\AccessTypeController;
use App\Http\Controllers\FormulAssignController;
use App\Http\Controllers\QuoteWindowController;

use App\Http\Controllers\ProjectWindowController;
/*
|--------------------------------------------------------------------------
| Web Routes
|--------------------------------------------------------------------------
...
Route::group(
    ...
    Route::get('proposal/create/{cid}', 'ProposalController@create')->name('proposal.create');
     Route::get('proposal/create2/{cid}', 'ProposalController@create2')->name('proposal.create2');
}
);
...
Route::resource('access-type', 'AccessTypeController')->middleware(
    [
        'auth',
        'XSS',
        'revalidate',
...
Route::resource('access', 'AccessoriesController')->middleware(
    [
        'auth',
        'XSS',
        'revalidate',
...
Route::get('balnce/entry/index', 'JournalEntryController@balanceindex')->name('balance-entry.index');
Route::get('balnce/entry/create', 'JournalEntryController@balancecreate')->name('balance.entry.create');
Route::post('balnce/entry/store', 'JournalEntryController@balancestore')->name('balance.entry.store');
Route::get('balance/ledger', 'JournalEntryController@ledgerSummary')->name('balnce.ledger');
Route::get('balnce/entry/show/{id}', 'JournalEntryController@balanceshow')->name('balance-entry.show');
...
Route::get(
    '/leads/{id}/remind', [
    'as' => 'leads.remind.create',
    'uses' => 'LeadController@remindCreate',
]
)->middleware(
    [
        'auth',
...
Route::get(
    '/leads/{id}/remind/{rid}/edit', [
    'as' => 'leads.reminds.edit',
    'uses' => 'LeadController@remindEdit',
]
)->middleware(
    [
        'auth',
...
Route::put(
    '/leads/{id}/remind/{rid}', [
    'as' => 'leads.reminds.update',
    'uses' => 'LeadController@remindUpdate',
]
)->middleware(['auth']);
Route::delete(
    '/leads/{id}/remind/{rid}', [
    'as' => 'leads.reminds.destroy',
    'uses' => 'LeadController@remindDestroy',
]
)->middleware(
    [
        'auth',
...
Route::post(
    '/leads/{id}/remind', [
    'as' => 'leads.remind.store',
    'uses' => 'LeadController@remindStore',
]
)->middleware(['auth']);
Route::get(
...
Route::get('image', [ImageController::class, 'index'])->middleware(
    [
        'auth',
        'XSS',
    ]
...
Route::get('image/create', [ImageController::class, 'create'])->middleware(
    [
        'auth',
        'XSS',
    ]
...
Route::post('image/store', [ImageController::class, 'store'])->middleware(
    [
        'auth',
        'XSS',
    ]
)->name('images.store');
Route::get('image/show', [ImageController::class, 'show'])->middleware(
    [
        'auth',
        'XSS',
    ]
)->name('images.show');
Route::post('image/edit', [ImageController::class, 'edit'])->middleware(
    [
        'auth',
        'XSS',
    ]
...
Route::get('formulas', [FormulaController::class, 'index'])->middleware(
    [
        'auth',
        'XSS',
    ]
...
Route::get('formulas/create', [FormulaController::class, 'create'])->middleware(
    [
        'auth',
        'XSS',
    ]
...
Route::post('formulas/store', [FormulaController::class, 'store'])->middleware(
    [
        'auth',
        'XSS',
    ]
)->name('formulas.store');
Route::get('formulas/show', [FormulaController::class, 'show'])->middleware(
    [
        'auth',
        'XSS',
    ]
)->name('formulas.show');
Route::post('formulas/edit', [FormulaController::class, 'edit'])->middleware(
    [
        'auth',
        'XSS',
    ]
)->name('formulas.edit');
Route::get('imgformulas', [ImageFormulaController::class, 'index'])->middleware(
    [
        'auth',
        'XSS',
    ]
)->name('imgformulas');
Route::get('imgformulas/create/{image}', [ImageFormulaController::class, 'create'])->middleware(
    [
        'auth',
        'XSS',
    ]
)->name('imgformulas.create');

Route::post('imgformulas/store', [ImageFormulaController::class, 'store'])->middleware(
    [
        'auth',
        'XSS',
    ]
)->name('imgformulas.store');
Route::get('imgformulas/show/{id}', [ImageFormulaController::class, 'show'])->middleware(
    [
        'auth',
        'XSS',
    ]
)->name('imgformulas.show');
Route::get('usrimg', [UserWindowController::class, 'index'])->middleware(
    [
        'auth',
        'XSS',
    ]
)->name('usrimg');
Route::get('usrimg/asigncreate/{data}', [UserWindowController::class, 'createassign'])->middleware(
    [
        'auth',
        'XSS',
    ]
)->name('usrimg.assigncreate');
Route::post('usrimg/assign', [UserWindowController::class, 'assign'])->middleware(
    [
        'auth',
        'XSS',
    ]
)->name('usrimg.assign');
Route::get('usrimg/statuscreate/{data}', [UserWindowController::class, 'createstatus'])->middleware(
    [
        'auth',
        'XSS',
    ]
)->name('usrimg.statuscreate');
Route::post('usrimg/status', [UserWindowController::class, 'status'])->middleware(
    [
        'auth',
        'XSS',
    ]
)->name('usrimg.status');
Route::get('usrimg/create/{image}', [UserWindowController::class, 'create'])->middleware(
    [
        'auth',
        'XSS',
    ]
)->name('usrimg.create');
Route::get('usrimg/list/{image}', [UserWindowController::class, 'image_list'])->middleware(
    [
        'auth',
        'XSS',
    ]
)->name('usrimg.list');
Route::get('usrimg/show/{id}', [UserWindowController::class, 'show'])->middleware(
    [
        'auth',
        'XSS',
    ]
)->name('usrimg.show');
Route::get('usrimg/edit/{id}', [UserWindowController::class, 'edit'])->middleware(
    [
        'auth',
        'XSS',
    ]
)->name('usrimg.edit');
Route::delete('usrimg/delete/{id}', [UserWindowController::class, 'destroy'])->middleware(
    [
        'auth',
        'XSS',
    ]
)->name('usrimg.destroy');
Route::post('usrimg/store', [UserWindowController::class, 'store'])->middleware(
    [
        'auth',
        'XSS',
    ]
)->name('usrimg.store');
Route::resource('formasign', 'FormulAssignController')->middleware(
    [
        'auth',
        'XSS',
    ]
);
Route::get('formasign/create/{image}', [FormulAssignController::class, 'create'])->middleware(
    [
        'auth',
        'XSS',
    ]
)->name('formasign.create');
...
Route::get('change_lead_status/{id}', [LeadController::class,'change_status'])->name('change_lead_status');
Route::get('leadincrement/{id}', 'LeadController@increment')->name('lead.increment');
Route::post(
    '/leads/order', [
    'as' => 'leads.order',
...
Route::get('export/lead', 'LeadController@ExportToExcel')->name('lead.export');
Route::post(
    '/leads/{id}/file', [
...
//new windows system
Route::resource('frames', 'FrameController')->middleware(
    [
        'auth',
        'XSS',
        'revalidate',
...
Route::resource('windows', 'ProjectWindowController')->middleware(
    [
        'auth',
        'XSS',
        'revalidate',
...
Route::get('windows/allshow/{id}', [ProjectWindowController::class, 'allshow'])->middleware(
    [
        'auth',
        'XSS',
    ]
)->name('windows.allshow');
Route::get('slideacess/{id}', [ProjectWindowController::class, 'slideaccesedit'])->middleware(
    [
        'auth',
        'XSS',
    ]
)->name('slideacess.edit');
Route::get('projwin/{id}', [ProjectWindowController::class, 'listedit'])->middleware(
    [
        'auth',
        'XSS',
    ]
...
Route::get(
    'projectwincutsheet/{id}', [
    'as' => 'projcut.sheet',
    'uses' => 'ProjectController@cutsheet',
]
)->middleware(
    [
        'auth',
...
Route::get(
    'projectallwincutsheet/{id}', [
    'as' => 'projcut.all.sheet',
    'uses' => 'ProjectController@allcutsheet',
]
)->middleware(
    [
        'auth',
...
Route::post(
    'projectacess/window/{id}', [
    'as' => 'project.windowacess.update',
    'uses' => 'ProjectWindowController@acessupdate',
]
)->middleware(
    [
        'auth',
...
Route::post(
    'projectopenacess/window/{id}', [
    'as' => 'project.windowopenacess.update',
    'uses' => 'ProjectWindowController@openacessupdate',
]
)->middleware(
    [
        'auth',
...
Route::resource('assignaccess', 'AssignAccessoriesController')->middleware(
    [
        'auth',
        'XSS',
        'revalidate',
...
Route::get(
    'assign/access/{id}/create', [
    'as' => 'assign.access.create',
    'uses' => 'AssignAccessoriesController@create',
]
)->middleware(
    [
        'auth',
...
Route::post(
    'assign/access/{id}', [
    'as' => 'assign.access.store',
    'uses' => 'AssignAccessoriesController@store',
]
)->middleware(
    [
        'auth',
...
Route::post(
    'openassign/access/{id}', [
    'as' => 'open.assign.access.store',
    'uses' => 'AssignAccessoriesController@openstore',
]
)->middleware(
    [
        'auth',
...
Route::post(
    'assign/dooraccess/{id}', [
    'as' => 'door.assign.access.store',
    'uses' => 'AssignAccessoriesController@doorstore',
]
)->middleware(
    [
        'auth',
...
Route::resource('assignwindows', 'AssignWindowController')->middleware(
    [
        'auth',
        'XSS',
        'revalidate',
...
Route::get(
    'assign/window/{id}/edit', [
    'as' => 'assign.window.edit',
    'uses' => 'AssignWindowController@edit',
]
)->middleware(
    [
        'auth',
...
Route::post(
    'assign/window/{id}', [
    'as' => 'assign.window.update',
    'uses' => 'AssignWindowController@update',
]
)->middleware(
    [
        'auth',
...
Route::get('projwindows/create/{id}', [ProjectWindowController::class, 'create'])->middleware(
    [
        'auth',
        'XSS',
    ]
)->name('projwindow.create');
Route::get('projwindows/door/create/{id}', [ProjectWindowController::class, 'doorcreate'])->middleware(
    [
        'auth',
        'XSS',
    ]
)->name('projwindow.door.create');

Route::post(
    'projects/{id}/window', [
    'as' => 'project.window.store',
    'uses' => 'ProjectWindowController@store',
]
)->middleware(
    [
        'auth',
...
Route::post(
    'projectsall/{id}/window', [
    'as' => 'projectall.window.store',
    'uses' => 'ProjectWindowController@allcost',
]
)->middleware(
    [
        'auth',
...
Route::get(
    'projects/window/{id}/edit', [
    'as' => 'project.window.edit',
    'uses' => 'ProjectWindowController@edit',
]
)->middleware(
    [
        'auth',
...
Route::post(
    'projects/window/{id}', [
    'as' => 'project.window.update',
    'uses' => 'ProjectWindowController@update',
]
)->middleware(
    [
        'auth',
...
Route::post(
    'projectsmul/window/{id}', [
    'as' => 'projectmul.window.update',
    'uses' => 'ProjectWindowController@mulionupdate',
]
)->middleware(
    [
        'auth',
...
Route::delete(
    'projects/window/{id}', [
    'as' => 'project.window.delete',
    'uses' => 'ProjectWindowController@destroy',
]
)->middleware(
    [
        'auth',
...
Route::post(
    'projectalls/quotesheet/{id}', [
    'as' => 'projectall.quote.sheet',
    'uses' => 'ProjectWindowController@quotesheet',
]
)->middleware(
    [
        'auth',
...
Route::delete(
    'projectQuote/window/{id}', [
    'as' => 'quote.window.delete',
    'uses' => 'QuoteWindowController@destroy',
]
)->middleware(
    [
        'auth',
...
Route::post(
    'projects/cost/{id}', [
    'as' => 'project.cost.update',
    'uses' => 'ProjectController@costupdate',
]
)->middleware(
    [
        'auth',
...
Route::get('change_win_status/{id}', [QuoteWindowController::class,'change_status'])->name('change_win_status');
Route::resource('project-quote', 'QuoteWindowController');
Route::get(
    'projects/{id}/quote', [
    'as' => 'project.quote',
    'uses' => 'QuoteWindowController@create',
]
)->middleware(
    [
        'auth',
...
Route::get(
    'projects/{id}/quote/index', [
    'as' => 'project.quote.index',
    'uses' => 'QuoteWindowController@index',
]
)->middleware(
    [
        'auth',
...
Route::post(
    'projects/quote/{id}', [
    'as' => 'project.quote.store',
    'uses' => 'QuoteWindowController@store',
]
)->middleware(
    [
        'auth',
...
Route::get(
    'projects/quotesheet/{id}', [
    'as' => 'project.quote.sheet',
    'uses' => 'QuoteWindowController@quotesheet',
]
)->middleware(
    [
        'auth',
...
Route::get(
    'projects/clientquote/{id}', [
    'as' => 'project.quote.client',
    'uses' => 'QuoteWindowController@clientquote',
]
)->middleware(
    [
        'auth',
...
Route::get('projectincrement/{id}/users/{uid}', 'ProjectController@increment')->name('project.increment');
...
Route::get(
    'projectwinlist/{id}', [
    'as' => 'projects.window.list',
    'uses' => 'ProjectController@windowlist',
]
)->middleware(
    [
        'auth',
